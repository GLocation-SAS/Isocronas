...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "flex size-full items-center justify-center rounded-full bg-primary/10 border border-primary/20 text-sm font-medium text-primary [&_svg]:text-primary group-data-[size=sm]/avatar:text-xs",
        className
      )}
      {...props}
    />
